...
public class MainController {
	...
	public String login(@RequestParam("username") String user, @RequestParam("password") String pwd, Model model,
		...
		// if user login username & password is correct then goes into Main page
		// where he can manage all medicine operation
		if (login != null) {
			model.addAttribute("loginuser", login);
			return "Main";
		} else {
			redirectAttributes.addFlashAttribute("error", "Invalid name & password");
